...
static void imgui_overlay_prepare_pipeline(imgui_overlay_t* imgui_overlay)
{
  ...
  WGPUColorStateDescriptor color_state_desc
    = wgpu_create_color_state_descriptor(&(create_color_state_desc_t){
      ...
      .enable_blend = imgui_overlay->settings.enable_alpha_blending,
    });
  ...
  // Create graphics rendering pipeline using the specified states
  imgui_overlay->pipeline = wgpuDeviceCreateRenderPipeline(
    ...
    &(WGPURenderPipelineDescriptor){
      ...
      .vertexState            = &vert_state_imgui,
      .sampleCount            = imgui_overlay->settings.msaa_sample_count,
