...
static void prepare_pipelines(wgpu_context_t* wgpu_context)
{
  ...
  /* Render pipeline: Solid mesh */
  {
    ...
    WGPUVertexState vertex_state = wgpu_create_vertex_state(
       ...
       .shader_desc = (wgpu_shader_desc_t){
         // Vertex shader WGSL
         .label             = "Render solid mesh vertex shader",
  ...
  /* Render pipeline: Points */
  {
    ...
    WGPUVertexState vertex_state = wgpu_create_vertex_state(
       ...
       .shader_desc = (wgpu_shader_desc_t){
         // Vertex shader WGSL
         .label            = "Render points vertex shader",
  ...
  /* Render pipeline: Wireframe */
  {
    ...
    WGPUFragmentState fragment_state = wgpu_create_fragment_state(
       ...
       .shader_desc = (wgpu_shader_desc_t){
         // Vertex shader WGSL
         .label            = "Render wireframe fragment shader",
         .wgsl_code.source = render_wireframe_wgsl,
         .entry            = "main_fragment",
       },
       .target_count = 1,
  ...
  /* Render pipeline: Wireframe Thick */
  {
    ...
    WGPUVertexState vertex_state = wgpu_create_vertex_state(
       ...
       .shader_desc = (wgpu_shader_desc_t){
         // Vertex shader WGSL
         .label            = "Render wireframe thick vertex shader",
    ...
    WGPUFragmentState fragment_state = wgpu_create_fragment_state(
       ...
       .shader_desc = (wgpu_shader_desc_t){
         // Vertex shader WGSL
         .label            = "Render wireframe thick fragment shader",
         .wgsl_code.source = render_wireframe_thick_wgsl,
         .entry            = "main_fragment",
       },
       .target_count = 1,
