...
static void prepare_pipelines(wgpu_context_t* wgpu_context)
{
  ...
  struct gltf_model_t* obj = models[0].object;
  WGPUVertexStateDescriptor* vert_state_pbr
    = wgpu_gltf_get_vertex_state_descriptor(
      obj, vertex_components, (uint32_t)ARRAY_SIZE(vertex_components));
