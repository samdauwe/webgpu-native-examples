...
static void prepare_pipelines(wgpu_context_t* wgpu_context)
{
  ...
  // Blur pipelines
  {
    ...
    // Vertical blur pipeline
    {
      ...
      WGPUVertexState vertex_state = wgpu_create_vertex_state(
                ...
                .shader_desc = (wgpu_shader_desc_t){
                  ...
                  .label = "Vertical gaussian blur vertex shader",
      ...
      WGPUFragmentState fragment_state = wgpu_create_fragment_state(
                ...
                .shader_desc = (wgpu_shader_desc_t){
                  ...
                  .label = "Vertical gaussian blur fragment shader",
    ...
    // Horizontal blur pipeline
    {
      ...
      WGPUVertexState vertex_state = wgpu_create_vertex_state(
                ...
                .shader_desc = (wgpu_shader_desc_t){
                  // Vertex shader SPIR-V
                  .label = "Horizontal gaussian blur vertex shader",
                  .file  = "shaders/bloom/gaussblur.vert.spv",
                },
                // Empty vertex input state
                .buffer_count = 0,
      ...
      WGPUFragmentState fragment_state = wgpu_create_fragment_state(
                ...
                .shader_desc = (wgpu_shader_desc_t){
                  // Fragment shader SPIR-V
                  .label = "Horizontal gaussian blur fragment shader",
  ...
  // Phong pass (3D model)
  {
    ...
    WGPUFragmentState fragment_state = wgpu_create_fragment_state(
              ...
              .shader_desc = (wgpu_shader_desc_t){
                // Fragment shader SPIR-V
                .label = "Phong pass fragment shader",
