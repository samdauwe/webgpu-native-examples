...
static void prepare_uniform_buffers(wgpu_example_context_t* context)
{
  ...
  scene_uniform_buffer = wgpuDeviceCreateBuffer(
    ...
    &(WGPUBufferDescriptor){
      .label = "UBO Scene - Uniform buffer",
...
static void setup_pipeline_layout(wgpu_context_t* wgpu_context)
{
  ...
  /* Bind group for uniform UBOScene */
  {
    WGPUBindGroupLayoutDescriptor bgl_desc = {
      .label      = "UBO Scene uniform - Bind group layout",
      .entryCount = 1,
  ...
  /* Bind group for uniform UBOScene material texture */
  {
    ...
    WGPUBindGroupLayoutDescriptor bgl_desc = {
      .label      = "UBO Scene material texture - Uniform bind group layout",
...
static void prepare_pipelines(wgpu_context_t* wgpu_context)
{
  ...
  WGPUVertexState vertex_state = wgpu_create_vertex_state(
            ...
            .shader_desc = (wgpu_shader_desc_t){
              /* Vertex shader */
              .label = "Solid mesh - Vertex shader SPIR-V",
