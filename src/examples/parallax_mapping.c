...
static void setup_pipeline_layout(wgpu_context_t* wgpu_context)
{
  ...
  bind_group_layout = wgpuDeviceCreateBindGroupLayout(
    wgpu_context->device, &(WGPUBindGroupLayoutDescriptor){
                            .label = "Parallax Mapping - Bind group layout",
  ...
  pipeline_layout = wgpuDeviceCreatePipelineLayout(
    wgpu_context->device, &(WGPUPipelineLayoutDescriptor){
                            .label = "Parallax Mapping - Pipeline layout",
...
static void setup_bind_group(wgpu_context_t* wgpu_context)
{
  ...
  bind_group = wgpuDeviceCreateBindGroup(
    wgpu_context->device, &(WGPUBindGroupDescriptor){
                            .label      = "Parallax Mapping - Bind group",
...
static void update_uniform_buffers(wgpu_example_context_t* context)
{
  ...
  glm_rotate(ubos.vertex_shader.model, glm_rad(-90.0f),
             (vec3){0.0f, 1.0f, 0.0f});
