...
static void setup_pipeline_layout(wgpu_context_t* wgpu_context)
{
  ...
  bind_group_layout = wgpuDeviceCreateBindGroupLayout(
    wgpu_context->device, &(WGPUBindGroupLayoutDescriptor){
                            .label      = "Texture Mipmap - Bind group layout",
  ...
  pipeline_layout = wgpuDeviceCreatePipelineLayout(
    wgpu_context->device, &(WGPUPipelineLayoutDescriptor){
                            .label = "Texture Mipmap - Pipeline layout",
...
static void setup_bind_group(wgpu_context_t* wgpu_context)
{
  ...
  bind_group = wgpuDeviceCreateBindGroup(
    wgpu_context->device, &(WGPUBindGroupDescriptor){
                            .label      = "Texture Mipmap - Bind group",
...
static void setup_render_pass(wgpu_context_t* wgpu_context)
{
  ...
  render_pass.descriptor = (WGPURenderPassDescriptor){
    .label                  = "Texture Mimap - Render pass descriptor",
...
static void prepare_pipelines(wgpu_context_t* wgpu_context)
{
  ...
  WGPUVertexState vertex_state = wgpu_create_vertex_state(
            ...
            .shader_desc = (wgpu_shader_desc_t){
              /* Vertex shader */
              .label = "Texture Mipmap - Vertex shader",
  ...
  WGPUFragmentState fragment_state = wgpu_create_fragment_state(
            ...
            .shader_desc = (wgpu_shader_desc_t){
              /* Fragment shader */
              .label = "Texture Mipmap - Fragment shader",
